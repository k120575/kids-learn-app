...
const List<(String, String)> soundAnimals = <(String, String)>[
  ('cat.mp3', '🐱'), ('dog.mp3', '🐶'), ('frog.mp3', '🐸'), ('pig.mp3', '🐷'),
  ('sheep.mp3', '🐑'), ('rooster.mp3', '🐓'), ('duck.mp3', '🦆'), ('horse.mp3', '🐴'),
  ('owl.mp3', '🦉'), ('goat.mp3', '🐐'), ('hen.mp3', '🐔'), ('crow.mp3', '🐦'),
  ('bee.mp3', '🐝'), ('cricket.mp3', '🦗'),
  ('elephant.mp3', '🐘'), ('tiger.mp3', '🐯'), ('wolf.mp3', '🐺'),
  ('whale.mp3', '🐋'),
];
final List<PickRound> soundHuntBank =
    buildSoundRounds(soundAnimals, '這是誰的聲音？');
