          ...
          child: ListView(
            ...
            children: achievements.map((Achievement a) {
              ...
              final int nextThreshold =
                  maxed ? a.tiers.last : a.tiers[tier];
              final double progress =
                  maxed ? 1.0 : (value / nextThreshold).clamp(0.0, 1.0);
                    ...
                    children: <Widget>[
                      ...
                      Opacity(
                        ...
                        child: Container(
                          ...
                          child:
                              Text(a.emoji, style: TextStyle(fontSize: context.s(28))),
                        ),
                      ),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                  fontSize: context.s(13), color: const Color(0xFF888888)),
                            ),
                          ],
                        ),
                      ),
